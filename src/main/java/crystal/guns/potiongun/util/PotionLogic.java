...
public class PotionLogic {
    ...
    protected static void prepareAndSpawnPotion(final World world, final LivingEntity entity, final PotionEntity potion, final int powerLevel) {
    ...
    protected static void createAndSpawnPotion(final World world, final LivingEntity shooter, final ItemStack potionStack, final int shrapnelLevel, final int powerLevel) {
